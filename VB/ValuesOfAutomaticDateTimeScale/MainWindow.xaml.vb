	...
	Partial Public Class MainWindow
		...
		Private Sub ChartControl_AxisScaleChanged(ByVal sender As Object, ByVal e As DevExpress.Xpf.Charts.AxisScaleChangedEventArgs)
			...
			If options Is Nothing Then
				Return
			End If
			axisX2D.Title = New AxisTitle With {
				.Visible = True,
				.Content = String.Format("The Axis Grid Alignment Unit is {0}" & vbCrLf & "The Axis Grid Spacing is {1}", options.GridAlignment, options.GridSpacing)
			}
		End Sub
	End Class
End Namespace
